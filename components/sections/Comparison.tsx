...
export default function Comparison() {
  return (
    <section className="bg-white pt-24 sm:pt-[28vw] pb-20 px-6 text-center relative z-0 overflow-hidden">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-12 md:gap-52 items-start max-w-4xl mx-auto">
          {/* VS divider */}
