          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              ...
              <div className="mt-6 relative w-[85%] mx-auto overflow-hidden p-4">
                <Image
                  src="/feature-smart-task-management.webp"
            ...
            >
              <div className="relative w-[55%] mx-auto p-4">
                <Image
                  src="/feature-calendar-deadlines.webp"
                  alt="Grid 2"
                  width={600}
                  height={400}
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              ...
              <div className="mt-6 relative flex items-end justify-center gap-4 translate-y-8">
                <Image
                  src="/feature-team-collab-left.webp"
                  alt="3rd"
                  width={380}
                  height={600}
                ...
                />
                <Image
                  src="/feature-team-collab-center.webp"
                  alt="2nd"
                  width={420}
                  height={720}
                ...
                />
                <Image
                  src="/feature-team-collab-right.webp"
                  alt="4th"
                  width={380}
                  height={600}
